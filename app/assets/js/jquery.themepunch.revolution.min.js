...
(function(e,t){
	function n()
	{
		...
		{
			if(navigator.userAgent.match(/OS 4_\d like Mac OS X/i)){e=true}
		}
		else
		{
			e=false
	...
	function r(r,i)
	{
		...
		if(i.simplifyAll=="on"&&(a(8)||n())){r.find(".tp-caption").each(function()
		{
			...
			if(i.forceFullWidth=="on"&&r.closest(".forcefullwidth_wrapper_tp_banner").length==0)
			{
				...
				if(m==t)
					m=0;
				r.parent().wrap('<div style="position:relative;width:100%;height:auto;margin-top:'+m+";margin-bottom:"+v+'" class="forcefullwidth_wrapper_tp_banner"></div>');r.closest(".forcefullwidth_wrapper_tp_banner").append('<div class="tp-fullwidth-forcer" style="width:100%;height:'+r.height()+'px"></div>');
				...
				if(!r.hasClass("revslider-initialised"))
				{
					...
					if(w==1&&E<7)
					{
						...
						if(!e.support.transition)
							e.fn.transition=e.fn.animate;r.find(".caption").each(function()
							{
									...
									r.find(".tp-caption").each(function(n)
									{
										try
										{
											if((e(this).data("ytid")!=t||e(this).find("iframe").attr("src").toLowerCase().indexOf("youtube")>0)&&x==0)
											{
												...
												var i="https";r.src=i+"://www.youtube.com/iframe_api";
										...
										try{
											...
											r.find(">ul:first-child >li").each(function()
											{
												...
												var B=r;r.find("ul").css({display:"block"});
												y(r,i);
												if(i.parallax!="off")
													et(r,i);
												if(i.slideamount>1)
